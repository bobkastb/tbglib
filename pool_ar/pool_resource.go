...
/*
Постановка задачи гомогенной обработки данных.
Множество горутин хотят выполнить тяжелую работу.  Тяжелую с точки зрения процессора, а не диска или базы данных.
Работа ведется через специальные процессы ОС. Каждый процесс может кушать много ресурсов (память, процессор), иногда это нужно пресекать.
Так как ресурс памяти и процессора конечен, то количество запущенных рабочих процессов также должно быть ограничено.
Для ограничения количества запущенных рабочих процессов и придуман пул с интерфейсом IPoolOfResource.
*/

/* Пул ресурсов.
Пул создается функцией NewPool
Ресурс должен иметь интерфейс ISingleResource. Ресурс может неожиданно завершиться. Максимальное количество активных ресурсов ограничивается.
